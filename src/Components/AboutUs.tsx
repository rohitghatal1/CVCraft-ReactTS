        ...
        <div className="aboutUsContainer">
          <fieldset className="owner">
            ...
            <div className="ownerInfo">
              <h3>Rohit Ghatal</h3>
              <p>
                A passionate full stack Web Developer with a knack for designing
                user interfaces. My journey began with a deep curiosity for
                website design, which has since evolved into a fulfilling career
                dedicated to full stack Web Development.
              </p>
